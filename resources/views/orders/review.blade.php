        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Product Rating
                    <a class="pull-right" href="{{ route('orders.index') }}">Order List</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="3" class="text-center">
                                    ...
                                    @else
                                        <a href="{{ route('orders.show', [$order->id]) }}" class="btn btn-primary">Show Orders</a>
                                    @endif
                                </td>
                            </tr>
                            </tfoot>
